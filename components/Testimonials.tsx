...
const SEED: { quote: string; name: string; role: string }[] = [
  ...
  { quote: "No motivational performance and no guru routines anywhere in the lessons — just practical frameworks I actually use every week on real deals, which turned out to be rarer than I expected when I started looking.", name: "Taylor H.", role: "BDR Lead" },
