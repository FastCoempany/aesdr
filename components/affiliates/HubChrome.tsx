...
const NAV_ITEMS = [
  { href: "/affiliates/program", label: "Program" },
  { href: "/affiliates/curriculum", label: "Curriculum" },
  { href: "/affiliates/kit", label: "Kit" },
  { href: "/affiliates/faq", label: "FAQ" },
  { href: "/affiliates/apply", label: "Apply" },
];
