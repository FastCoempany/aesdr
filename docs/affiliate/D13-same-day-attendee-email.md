...
>
> ***Three — the offer, and the honest thing.*** *AESDR is the 12-course program — $249 SDR / $299 AE / $1,499 Team, lifetime access from day one, and a 14-day no-questions-asked refund window backing the whole thing. Enrollment link:* `aesdr.com/[affiliate-slug]/enroll · code [PILOT-CODE] · closes [date]`*.*
>
