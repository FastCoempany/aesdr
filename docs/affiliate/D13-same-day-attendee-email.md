...
>
> ***Two — the replay.*** *Open for the next 48–72 hours at* `aesdr.com/[affiliate-slug]/replay/[token]`*. After that, it closes — we don't run this as evergreen content, and we don't sell the recording.*
>
> ***Three — the offer, and the honest thing.*** *AESDR is the 12-course program — $249 SDR / $299 AE, Team up to 10 is contact-for-pricing, your login keeps working from day one, and a 14-day no-questions-asked refund window backing the whole thing. Enrollment link:* `aesdr.com/[affiliate-slug]/enroll · code [PILOT-CODE] · closes [date]`*.*
>
...
> `aesdr.com/[affiliate-slug]/enroll · code [PILOT-CODE] · closes [date]`
...
This worksheet is itself a affiliate-facing brand asset — it has to feel like part of AESDR, not a generic PDF.
