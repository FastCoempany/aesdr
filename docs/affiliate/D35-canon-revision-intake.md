...
Canon revisions accumulate. Most are good (`7c6aead` v1.1 added custom-iconography doctrine — earned its place); some would be bad if undisciplined (an affiliate pushes for an exception, the founder caves, the canon shifts to fit the affiliate). The template forces the proposer to answer five questions before the edit lands:
...
- **Affiliate conversation.** Reference D27 scorecard or the call note. **Important:** if an affiliate pushed for the change, name that explicitly. The bias is to decline affiliate-driven canon changes unless the affiliate identified a genuine canon weakness.
...
- [ ] If any affiliate is mid-pilot, surface the change in the next D25 weekly report's §1 headline (only if the change affects their pilot — most won't).
...
> Triggering signal: D33 postmortem from pilot `c_2026-06-apex` §5 objection log — "5 of 18 affiliate-audience replies asked specifically about a Team-tier purchase pathway. Current FAQ Q07 disqualifies team-buyers; canon §13 doesn't address Team-tier-led intake."
>
...
- **D27 affiliate vetting scorecard** as a triggering-signal source. **Met.**
