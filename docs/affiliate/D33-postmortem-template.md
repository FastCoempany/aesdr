...
**Audience:** Internal — founder, ops, future-AESDR. Not shared with the affiliate.
**Voice ratio:** 70 Rowan / 30 Michael. Honest is the only tone that works.
**Format:** Markdown source; one file per pilot at `docs/affiliate/pilots/[affiliate-slug]/postmortem--v1.md`.
...
Filled out within 7 days of the pilot's end, after the cut-or-keep memo (D32) and the affiliate-facing close-out (D34) are done. Postmortem comes *after* those two on purpose: the decision shouldn't be contaminated by retrospective second-guessing, and the affiliate shouldn't be in the room while we critique ourselves.
...
|---|---|---|
| D27 affiliate vetting scorecard v1 | `docs/affiliate/pilots/[affiliate-slug]/scorecard--v1.md` | §6 ICP fit, §10 single sentence (compare to v0 expectation) |
| D25 weekly reports (Reports 1, 2, 3) | Sent to affiliate; archived in pilot folder | §2 numbers vs plan, §3 what worked, §4 what broke |
| D17 high-intent DM log | `docs/affiliate/pilots/[affiliate-slug]/d17-log.md` | §5 objections heard (richest single source) |
...
| L&D-approver brief send + outcome log | `docs/affiliate/pilots/[affiliate-slug]/L-and-D/` | §6 ICP fit (approval rate is a fit proxy) |
| D32 cut-or-keep memo | `docs/affiliate/pilots/[affiliate-slug]/cut-or-keep--v1.md` | §2 numbers (lifted), §10 single sentence (cross-check) |
| D34 affiliate-facing close-out | Sent to affiliate; archived in pilot folder | §3 what worked (the affiliate relationship), §9 lessons for next pilot |
...
> *(Mono eyebrow)*
> `AESDR · PILOT POSTMORTEM · [Affiliate slug] · [Pilot ID]`

> *(Display italic, ~36pt)*
> *Postmortem: [Affiliate name]*
...
- D5 (affiliate-objection reply bank) — for affiliate-side counter-asks.
- The deck (`Q&A preparation` slide) — for the host.

### 6. ICP fit assessment

Independent of revenue. The affiliate could have produced a money pilot with the wrong audience, or a low-money pilot with exactly-right audience. Both matter — and they tell us different things.
...
- **Did the affiliate's promo hold the canon?** [Y / N — note]
...
- **What we'll do differently in the affiliate relationship:** [text]
...
This sentence goes into the rolling pilot index at `docs/affiliate/pilots/_INDEX.md` (pending build).
...
- The postmortem is internal *only*. Do not share it with the affiliate — the affiliate gets D34 (the close-out note) and an honest summary in conversation, not the raw postmortem. Postmortems contain critiques of our own deck and our own offer that don't belong in a affiliate-facing surface.

## Open

- Pilot index file `docs/affiliate/pilots/_INDEX.md` doesn't exist yet — produce when first pilot ships, not before.
...
- Whether the postmortem includes a section on affiliate economics (their commission, their cost-of-attention, their satisfaction). Default: yes, fold into §3 ("In the affiliate relationship") and §4 ("Founder-time blowouts"). No separate section unless data shows we need it.
