# 10d — AESDR × Affiliate Lockup Usage Guide

> **What this is:** The rules for using the AESDR × Affiliate co-brand lockup. Lifts canon §6.6 affiliate co-branding zone and adds the practical worked examples affiliates need. The lockup is the most-visible cross-pollination of AESDR's brand and yours; the lockup-usage discipline is what keeps the cross-pollination from becoming a brand collision.
>
...
- **Affiliate mark:** Your canonical color, in your canonical render. AESDR is not opinionated about your brand color.
...
| Surface | Placement |
|---|---|
| Affiliate-specific landing page | Top-center, in the page's header band |
| Affiliate-specific deck | Top-left of every slide except the editorial-split title cards (where the AESDR wordmark alone carries) |
| Email | Footer-only |
...
- **Change the typography.** AESDR is `--display` italic 900; affiliate mark is yours-as-supplied. Do not re-typeset AESDR in a different face.
- **Change the `×` glyph.** It's a multiplication sign in `--mono`, not an em-dash, not a plus sign, not a slash.
- **Add a third mark.** The lockup is two-mark by canon. A third entity ("AESDR × `[AFFILIATE]` × [SUB-AFFILIATE]") is forbidden — that's a different relationship than the pilot.
- **Add a tagline below the lockup** ("Affiliates in early-career sales!"). Forbidden — taglines belong in body type per `00-canon-excerpt.md` §14.
...
- **First instance of the lockup on a new surface for your affiliateship** — pre-approval before publish. Submit the layout 48h pre-publish per D40 §3.
...
*Source: canon §6.6 (affiliate co-branding zone) + canon §6.9 (visual QA discipline). Pre-cleared examples are affiliate-friendly extensions of the canon, not departures from it.*
