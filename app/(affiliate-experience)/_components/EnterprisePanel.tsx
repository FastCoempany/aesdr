...
function SuccessState() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      {/* Standard external redirect to the Google appointment schedule.
          Carries data-preview-allow so PreviewOnlyWrap doesn't intercept
          this legit booking-flow exit. New tab so the prospect's /x/
          session stays preserved. */}
      <a
        href={CALENDAR_URL}
        target="_blank"
