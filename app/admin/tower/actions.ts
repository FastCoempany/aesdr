...
// (runScoutSweepAction is gone: the tower's sweep buttons post to
// /api/admin/run-sweep, whose runSweepAndInsert engine now carries the warren
// consolidation — auto-promote + brief + email hunt for the whole catch. One
// sweep path, not two.)
