...
import { CommandLayer } from "@/components/preview/CommandLayer";
...
export default async function CommandPreviewPage({ searchParams }: Props) {
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        Sandbox · /preview/command · not live
      </div>
    </div>
  );
}
