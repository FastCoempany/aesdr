...
import { QuarryLayer } from "@/components/preview/QuarryLayer";
...
export default async function QuarryPreviewPage({ searchParams }: Props) {
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        Sandbox · /preview/quarry · not live
      </div>
    </div>
  );
}
