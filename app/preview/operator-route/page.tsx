...
import { RouteLayer } from "@/components/preview/RouteLayer";
...
export default async function RoutePreviewPage({ searchParams }: Props) {
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        Sandbox · /preview/operator-route · not live
      </div>
    </div>
  );
}
