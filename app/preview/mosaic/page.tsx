...
import { MosaicLayer } from "@/components/preview/MosaicLayer";
...
export default async function MosaicPreviewPage({ searchParams }: Props) {
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        Sandbox · /preview/mosaic · not live
      </div>
    </div>
  );
}
