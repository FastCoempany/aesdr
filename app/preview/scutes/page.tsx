...
import { ScutesLayer } from "@/components/preview/ScutesLayer";
...
export default async function ScutesPreviewPage({ searchParams }: Props) {
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        Sandbox · /preview/scutes · not live
      </div>
    </div>
  );
}
