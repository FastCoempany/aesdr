...
import { StrataLayer } from "@/components/preview/StrataLayer";
...
export default async function StrataPreviewPage({ searchParams }: Props) {
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        Sandbox · /preview/strata · not live
      </div>
    </div>
  );
}
