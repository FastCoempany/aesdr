...
import { BurrowLayer } from "@/components/preview/BurrowLayer";
...
export default async function BurrowPreviewPage({ searchParams }: Props) {
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        Sandbox · /preview/burrow · not live
      </div>
    </div>
  );
}
