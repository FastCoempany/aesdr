...
import { ThicketLayer } from "@/components/preview/ThicketLayer";
...
export default async function ThicketPreviewPage({ searchParams }: Props) {
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        Sandbox · /preview/thicket · not live
      </div>
    </div>
  );
}
