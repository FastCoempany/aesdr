...
import { TracksLayer } from "@/components/preview/TracksLayer";
...
export default async function TracksPreviewPage({ searchParams }: Props) {
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        Sandbox · /preview/tracks · not live
      </div>
    </div>
  );
}
