...
} from "@/lib/affiliate-kit-private";
import { readKitSession } from "@/lib/affiliate-kit-session";
import { logAccess } from "@/lib/affiliate-kit-tokens";
...
export default async function PrivateKitDocPage(
  ...
  if (!session) {
    redirect(`/affiliates/kit-private?next=${encodeURIComponent(`/affiliates/kit-private/${slug}`)}`);
  }
