...
export default function ProgramPage() {
  return (
    <HubPage>
      ...
      >
        {[
          { href: "/affiliates/economics", label: "See the math →", sub: "Calculator + worked example + tracking stack" },
          { href: "/affiliates/timeline", label: "See the pilot week-by-week →", sub: "Anatomy of a pilot, Week 0 through payment" },
          { href: "/affiliates/payments", label: "Payment details →", sub: "Methods, taxes, refunds, the sign-on bonus" },
        ].map((l) => (
          <a
            key={l.href}
            href={l.href}
