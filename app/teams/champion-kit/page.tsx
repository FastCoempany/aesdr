...
/**
 * /teams/champion-kit — what a champion sends up the chain.
 *
 ...
 *
 * Pairs with /teams/procurement (security/legal/L&D) — that one's for
 * the reviewers, this one's for the buyer.
 */

export const metadata = {
  title: "Champion kit — AESDR / for Teams",
  description:
    "Forwardable materials for the champion making the case for AESDR / for Teams to whoever owns the budget. Two paragraphs, thirty seconds, and the objections you'll actually hear.",
        ...
        <div className={styles.containerNarrow}>
          ...
          >
            ...
            <p style={{ margin: "0 0 14px" }}>
              I want to pull AESDR / for Teams in for our [SDRs / AEs / sales team].
            ...
            <p style={{ margin: "0 0 14px" }}>
              ...
              you&apos;d like to read them — <a href="https://aesdr.com/teams/procurement" style={{ color: "var(--crimson)" }}>aesdr.com/teams/procurement</a> for
      ...
      <section className={`${styles.sectionTight} ${styles.sectionDivider}`}>
        <div className={styles.containerNarrow}>
          ...
          <div style={{ marginTop: 24 }}>
            <InlineCTA href="/teams/contact?source=champion-kit">
