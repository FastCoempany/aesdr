...
/**
 * /teams/diagnostic — rep behavior diagnostic spec.
 *
 * Eight dimensions of early-career rep behavior. Each rendered as a spec
...
const DIMENSIONS: Dimension[] = [
  {
    ...
    why: "Volume alone doesn't sell, but reps below threshold can't possibly hit quota regardless of skill. Identifies the floor.",
    sampleItems: [
      ...
      "Manager rating: 1–5 scale on whether rep maintains baseline activity without prompting",
    ],
    typicalDelta: "Reps starting below their team's 50th percentile typically lift 30–60% on dials and 20–40% on emails within 6 weeks. Reps already at or above median move less — Module 1 (Structure) is the primary lift driver.",
  },
  {
    number: "02",
    name: "Outbound personalization quality",
    role: "SDR",
    what: "Per-touch quality — not just whether the email used the prospect's first name. Did the rep reference something specific to the buyer's role / company / recent activity?",
    why: "Personalization is the only thing that survives volume scaling. Reps who learn this in month 2 compound; reps who don't plateau at month 6.",
    sampleItems: [
  ...
  },
  {
    ...
    role: "Both",
    what: "On qualified calls, the rep's discovery sequence — how many clarifying questions per topic, how often they probe past the first answer, how much they listen vs. talk.",
    why: "Junior reps interrogate to qualify; experienced reps interrogate to understand. The gap is bridgeable with structured practice.",
    sampleItems: [
      "Call-recording review: average questions per topic before moving on (1–2 = shallow, 3+ = deep)",
      "Talk/listen ratio on discovery calls (target: under 40% rep talk-time on disco)",
      "Manager rating: 'Rep probed past surface answers to reach the actual driver' (1–5)",
  ...
  },
  {
    ...
    role: "Both",
    what: "Quality of the weekly 1:1 with the rep's manager. Does the rep show up with their own agenda? Do they push back when they disagree? Do they ask for specific coaching?",
    why: "1:1s are the single biggest leverage point in a rep's first year. Reps who treat them as performance theater get coached badly; reps who run them as working sessions accelerate.",
    sampleItems: [
      "Manager rating: 'Rep arrives with a clear agenda and proposed talking points' (1–5)",
      "Manager rating: 'Rep pushes back constructively when we disagree' (1–5)",
      "Self-rating: 'I leave 1:1s having gotten what I needed' (1–5)",
      "Frequency of rep-initiated coaching requests in the past month (count)",
    ],
    typicalDelta: "Module 1 (Foundations) ships strongest lift here. Managers consistently report 'less performance theater, more honest signal' within 2–3 weeks of rep completing Module 1.3 (Mastering Coaching).",
  },
  {
    number: "05",
    ...
    why: "This is the most-cited break-point in user feedback. Reps quit over bad AE/SDR relationships more often than over bad managers.",
    sampleItems: [
  ...
  },
  {
    ...
    name: "CRM hygiene",
    role: "Both",
    what: "Quality of CRM data the rep maintains: next-step accuracy, opportunity stage discipline, contact role tagging, activity logging consistency.",
    why: "Bad CRM data corrupts every downstream signal — forecast, manager coaching, peer handoff, marketing attribution. Most reps treat CRM as compliance; AESDR reframes it as personal leverage.",
    sampleItems: [
      ...
      "Manager rating: 'I can forecast from this rep's data without manual cleanup' (1–5)",
    ],
    typicalDelta: "Module 9 (The Tools That Ruin You) is the unlock here. Reps who complete 9.1 (CRM Survival Guide) typically see manager-rated forecasting quality improve from 2.5 → 3.5 on average within a month.",
  },
  {
    number: "07",
  ...
  },
  {
    ...
    role: "Both",
    what: "How the rep uses Slack, email, Notion / docs. Do they protect deep work? Do they batch responses? Do they distinguish urgent from theatrical urgency?",
    why: "Reps drown in async noise. The ones who develop discipline early outpace the ones who don't — not because they work less, but because they spend their hours on the right things.",
    sampleItems: [
      ...
      "Manager rating: 'This rep distinguishes urgent from urgent-feeling' (1–5)",
    ...
    <>
      <section className={styles.hero}>
        <div className={styles.container}>
          ...
          <p className={styles.heroSubhead}>
            A before/after diagnostic for measuring rep behavior change. Eight dimensions, administered at week 0 and week 8. Built for managers who need to justify the investment without inventing a number.
          </p>
        </div>
      </section>
      ...
      <section className={`${styles.sectionTight} ${styles.sectionDivider}`}>
        <div className={styles.containerNarrow}>
          ...
          <ul className={styles.bulletList}>
            <li>
              <strong>Self-report.</strong> Rep completes the instrument at week 0
              (before starting AESDR) and again at week 8 (end of program). ~30
              minutes each, online form.
            </li>
            <li>
              <strong>Manager rating.</strong> Manager rates the rep on the same
              dimensions, at the same two points. Done independently of the rep&apos;s
              self-report — surfaces gaps where rep and manager see things
              differently.
            </li>
            <li>
      ...
      <section className={`${styles.sectionTight} ${styles.sectionDivider}`}>
        <div className={styles.containerNarrow}>
          ...
          <p className={styles.body}>
            We don&apos;t publish a single &ldquo;average lift&rdquo; number across all dimensions. It would be marketing-grade dishonest — your numbers depend on where reps start, how strong your manager culture is, and which dimensions you actually invest in measuring.
          </p>
          <p className={styles.body}>
