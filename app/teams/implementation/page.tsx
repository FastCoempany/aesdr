...
/**
 * /teams/implementation — manager rollout guide.
 *
 ...
 * CSS print styles in teams.module.css. PR 4 ships the PDF version.
 */
    ...
    <>
      ...
      <section className={`${styles.sectionTight} ${styles.sectionDivider}`}>
        <div className={styles.containerNarrow}>
          ...
          <ul className={styles.bulletList}>
            <li>
              You&apos;ll read the curriculum in parallel with your reps. Not all 36 lessons, but at least the modules they&apos;re currently working through.
            </li>
            <li>
              You&apos;ll hold weekly 1:1s with each rep where AESDR is on the agenda for ~5 minutes. Just enough to ask &ldquo;what landed&rdquo; and &ldquo;what felt wrong.&rdquo;
            </li>
            <li>
              You won&apos;t treat completion as the goal. The goal is rep behavior change, measured by the diagnostic (week 0 / week 8). Reps who race to finish but don&apos;t change behavior have wasted the program.
            </li>
            <li>
              You&apos;ll let reps who push back push back. Some lessons (8.x, 10.x, 12.3) are deliberately provocative. Reps who hate them often have the most to learn from them.
            </li>
          </ul>
      ...
      <section className={`${styles.sectionTight} ${styles.sectionDivider}`}>
        <div className={styles.container}>
          ...
          >
            <ul className={styles.bulletList}>
              <li>Administer the diagnostic — self-report instrument to each rep, manager rating sheet for yourself (per-rep). ~30 min per rep, ~30 min for your ratings.</li>
              ...
              <li>Identify two reps in advance: the rep who needs the most support, and the rep most likely to evangelize. Plan extra check-ins with the first; let the second carry social energy.</li>
          ...
          <SpecSection
            ...
            meta={[
              ...
              { label: "Rep time", value: "~3 hrs over the two weeks" },
            ]}
          >
            <p className={styles.bodyDense} style={{ marginBottom: 12 }}>
              The structure-building foundation. Reps learn to run their own
            ...
            <ul className={styles.bulletList}>
              <li>Week 1 1:1: ask each rep &ldquo;What surprised you in 1.1 Creating Structure?&rdquo; Listen, don&apos;t coach.</li>
          ...
          >
            ...
            <p className={styles.h4}>Manager touchpoints this fortnight</p>
            <ul className={styles.bulletList}>
              <li>Pre-read 3.3 (Surviving AE Management) yourself, before reps do. Some content will feel personal. It&apos;s not — but you&apos;ll want to have processed it before you discuss it.</li>
          ...
          <SpecSection
            ...
            meta={[
              ...
              { label: "Rep time", value: "~3.5 hrs over the two weeks" },
            ]}
          >
            <p className={styles.bodyDense} style={{ marginBottom: 12 }}>
              The closest AESDR comes to traditional SDR training. Module 5 is the framework reps will coach against for the rest of their career. Module 6 builds out networking + curiosity skills the playbook leaves out.
            </p>
            <p className={styles.h4}>Manager touchpoints this fortnight</p>
            <ul className={styles.bulletList}>
          ...
          <SpecSection
            ...
            meta={[
              ...
              { label: "Rep time", value: "~4.5 hrs over the two weeks" },
            ]}
          >
            <p className={styles.bodyDense} style={{ marginBottom: 12 }}>
              The harshest stretch. 7.3 gives reps explicit permission to question whether SaaS is right for them. 8.x asks them whether they&apos;re the problem. 9.x ships the CRM Survival Guide as a permanent takeaway tool.
            </p>
            <p className={styles.h4}>Manager touchpoints this fortnight</p>
            <ul className={styles.bulletList}>
              <li>Brace for one or two reps to surface &ldquo;maybe I&apos;m not cut out for this.&rdquo; Take it seriously. Some of those reps need to leave; some need to be reassured. The conversation matters either way.</li>
              ...
              <li>End of week 8: 60-min team wrap-up. Topic: &ldquo;What did we learn? What are we doing differently? Which two reps changed the most, and what did they do?&rdquo;</li>
            </ul>
            <div className={styles.specCallout}>
              <strong style={{ fontStyle: "normal", color: "var(--ink)" }}>Note about modules 10–12: </strong>
              The 8-week structured rollout covers modules 1–9. Modules 10–12 (commission/comp, off-the-clock, life outside work) are best worked through individually over the following months, not in cohort format. Reps engage with them when relevant — they&apos;re standalone enough to be self-paced.
            </div>
          </SpecSection>
        </div>
      </section>
      ...
      <section className={`${styles.sectionTight} ${styles.sectionDivider}`}>
        <div className={styles.containerNarrow}>
          ...
          <h2 className={styles.h2}>What reps walk out with.</h2>
          <hr className={styles.divider} />
          <p className={styles.body}>
            AESDR ships five tools that live outside the course. Reps keep them, use them, modify them, share them with peers. Each one comes from a specific lesson but works standalone.
          </p>
          <ul className={styles.bulletList}>
            <li>
      ...
      <section className={`${styles.sectionTight} ${styles.sectionDivider}`}>
        <div className={styles.containerNarrow}>
          ...
          <ul className={styles.bulletList}>
            <li>
              <strong>Treating it like compliance training.</strong> Forcing reps to
            ...
            <li>
              <strong>Skipping the manager&apos;s parallel reading.</strong> Reps notice
            ...
            <li>
              <strong>Pushing reps to finish in 4 weeks.</strong> The 8-week design
              isn&apos;t arbitrary — it&apos;s spaced repetition. Reps need time between
            ...
            <li>
              ...
              reps a shared language.
            </li>
            <li>
              <strong>Tracking only completion.</strong> Completion is necessary,
              not sufficient. Track behavior change via the diagnostic. If reps
              are completing without diagnostic delta, something is wrong with
              how you&apos;re running the rollout, not with the curriculum.
            </li>
            <li>
              <strong>Holding reps who push back accountable for compliance.</strong>{" "}
              Reps who push back hardest on lessons 8.x are often the reps with the
      ...
      <section className={`${styles.sectionTight} ${styles.sectionDivider}`}>
        <div className={styles.containerNarrow}>
          ...
          <hr className={styles.divider} />
          <p className={styles.body}>
            Best fit calls cover three things: your team composition (SDR/AE mix, tenure distribution, recent hires), your manager culture (how 1:1s actually run today, what you can and can&apos;t enforce), and your timeline (when reps need to be productive). 30 minutes is enough to know whether AESDR is a fit or not.
          </p>
          <div style={{ marginTop: 24, display: "flex", gap: 16, flexWrap: "wrap" }}>
            <InlineCTA href="/teams/contact?source=implementation">Scope a rollout</InlineCTA>
