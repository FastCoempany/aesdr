...
/**
 * /teams/downloads/diagnostic-instrument — fully digital, downloadable.
 *
...
export const metadata = {
  title: "AE/SDR diagnostic instrument — AESDR / for Teams",
    ...
    <section className={styles.section} style={{ paddingTop: 24 }}>
      <div className={styles.container} style={{ maxWidth: 960 }}>
        ...
        <div className={styles.downloadHowto} style={{ marginTop: 32 }}>
          ...
          measures is on <strong>/teams/diagnostic</strong>.
        </div>
      </div>
    </section>
  );
