...
/**
 * Numbered spec section. Used on /enterprise/curriculum (one per lesson),
 * /enterprise/diagnostic (one per dimension), /enterprise/implementation (one per
 * week), /enterprise/integrations (one per integration).
 *
