...
/**
 * /enterprise/contact — single-purpose inquiry capture.
 *
 * Calm, low-friction. No "Schedule a meeting in 3 clicks" overlay,
 * no chatbot, no Calendly embed. Just the form. Responses route to
 * hello@aesdr.com with subject prefix [/enterprise inquiry].
 */

export const metadata = {
  title: "Contact — AESDR / Enterprise",
      ...
      <div className={styles.containerNarrow}>
        ...
        <div style={{ borderTop: "1px solid var(--light)", paddingTop: 24 }}>
          <p className={styles.bodyMuted} style={{ marginBottom: 0 }}>
            ...
            <a
              href="mailto:hello@aesdr.com?subject=%5B%2Fenterprise%5D"
              style={{ color: "var(--ink)", textDecoration: "underline" }}
            >
              hello@aesdr.com
            </a>
            {" "}with subject <code style={{ fontFamily: "var(--mono)", fontSize: 13, background: "var(--cream)", border: "1px solid var(--light)", padding: "1px 6px" }}>[/enterprise]</code>.
