...
/**
 * /enterprise/procurement — procurement-readiness one-pager.
 *
...
export const metadata = {
  title: "Procurement — AESDR / Enterprise",
  description:
    "What your security, legal, and L&D teams need to clear an AESDR / Enterprise purchase. Honest state, no marketing-grade compliance puffery.",
      ...
      <section className={`${styles.sectionTight} ${styles.sectionDivider}`}>
        <div className={styles.containerNarrow}>
          ...
          <div style={{ marginTop: 24 }}>
            <InlineCTA href="/enterprise/contact?source=procurement">
