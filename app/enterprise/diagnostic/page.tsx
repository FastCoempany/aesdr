...
/**
 * /enterprise/diagnostic — AE/SDR behavior diagnostic spec.
 *
...
export const metadata = {
  title: "Diagnostic — AESDR / Enterprise",
      ...
      <section className={`${styles.sectionTight} ${styles.sectionDivider}`}>
        <div className={styles.containerNarrow}>
          ...
          <div style={{ marginTop: 24, display: "flex", gap: 16, flexWrap: "wrap" }}>
            <InlineCTA href="/enterprise/contact?source=diagnostic">Talk about diagnostic administration</InlineCTA>
            <InlineCTA href="/enterprise/downloads/diagnostic-instrument" variant="arrow">
