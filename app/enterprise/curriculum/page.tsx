...
const COURSES: Course[] = [
  ...
  },
  {
    ...
    duration: "~80 min",
    managerNote:
      "Ships the Manager Archetype Map as a takeaway artifact. Surprisingly diagnostic for managers reading it themselves — most find their own archetype on the list.",
  },
  {
    number: "05",
    theme: "The playbook",
