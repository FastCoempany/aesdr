...
/**
 * /enterprise/integrations — what's live, what's planned.
 *
...
export const metadata = {
  title: "Integrations — AESDR / Enterprise",
      ...
      <section className={`${styles.sectionTight} ${styles.sectionDivider}`}>
        <div className={styles.containerNarrow}>
          ...
          <div style={{ marginTop: 24 }}>
            <InlineCTA href="/enterprise/contact?source=integrations">Talk about a custom integration</InlineCTA>
          </div>
        </div>
      </section>
    </>
