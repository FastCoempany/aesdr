        ...
        <article className={styles.onepageContainer}>
          ...
          <header className={styles.onepageHeader}>
            <span>
              ...
              <span className={styles.certMarkSuffix}>/ Enterprise</span>
            </span>
          ...
          <p className={styles.onepageBody}>
            12 courses × 3 lessons (36 total, ~16 hours run-time). Seven takeaway artifacts
          ...
          <div className={styles.onepageContact}>
            <span>Inquiries</span>
            <span>
              <a href="mailto:hello@aesdr.com?subject=%5B%2Fenterprise%5D%20Partnership">
                hello@aesdr.com
              </a>
              {" · "}
              aesdr.com/enterprise
            </span>
          </div>
        </article>
