...
/**
 * /enterprise/downloads — index of downloadable artifacts.
 *
...
const ARTIFACTS = [
  {
    ...
    description:
      "The full 8-week rollout sequence with manager touchpoints, the substantial assets AEs and SDRs keep, and common mistakes. Read on web or print-to-PDF.",
    pages: "~12 pages when printed",
  },
  {
    href: "/enterprise/downloads/certificate",
    eyebrow: "ARTIFACT 02 · CERTIFICATE",
    title: "Completion certificate generator",
    description:
      "Enter AE/SDR name + completion date + program scope. Generates a printable certificate in the AESDR / Enterprise brand. One per AE/SDR.",
  ...
  {
    href: "/enterprise/downloads/diagnostic-instrument",
