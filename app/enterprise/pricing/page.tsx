...
export const metadata = {
  title: "Pricing — AESDR / Enterprise",
        ...
        <div className={styles.container}>
          <div className={styles.cardGrid3}>
            ...
            <BuyerModeCard
              ...
              ctaHref="/enterprise/contact?source=pricing-custom"
            ...
            <BuyerModeCard
              ...
              description="For channel partners packaging AESDR inside their own offering. We deliver the 12 courses + the substantial assets that ship with them; you wrap them in your brand. Revenue-share or wholesale pricing."
              features={[
                "Delivery rights to lessons + the substantial assets",
              ...
              ctaHref="/enterprise/contact?source=pricing-wl"
      ...
      <section className={`${styles.section} ${styles.sectionDivider}`}>
        <div className={styles.containerNarrow}>
          ...
          <FAQ q="Is the Team tier the same product as the consumer course?">
            Yes. Identical 12 courses, identical substantial assets. The differences are the manager dashboard layered on top, the priority Slack support line, and the L&amp;D-formatted invoice.
          </FAQ>
          ...
          <FAQ q="What integrations exist today?">
            ...
            <Link href="/enterprise/integrations" style={{ color: "var(--ink)", textDecoration: "underline" }}>
              Full state on the integrations page.
            </Link>
          </FAQ>

          <div style={{ marginTop: 40 }}>
            <InlineCTA href="/enterprise/contact?source=pricing-faq">Book a 30-min walkthrough</InlineCTA>
          </div>
        </div>
      </section>
    </>
