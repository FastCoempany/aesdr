    ...
    <HubPage>
      ...
      <article style={essayStyle}>
        ...
        <ul style={listStyle}>
          ...
          <li><strong>Three to five partners. That&rsquo;s the program.</strong> Small list, careful curation, honest yield. We don&rsquo;t recruit at scale and we don&rsquo;t run a marketplace. Conversion quality matters; volume doesn&rsquo;t.</li>
