...
- Name: api-critical-paths.spec.ts >> Stripe webhook security >> rejects requests without stripe-signature header
- Location: tests\e2e\api-critical-paths.spec.ts:116:7
