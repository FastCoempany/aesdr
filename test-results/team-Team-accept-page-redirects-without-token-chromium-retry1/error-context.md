...
- Name: team.spec.ts >> Team accept page >> redirects without token
- Location: tests\e2e\team.spec.ts:20:7
...
Received string:  "http://localhost:3000/team/accept"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    8 × unexpected value "http://localhost:3000/team/accept"
