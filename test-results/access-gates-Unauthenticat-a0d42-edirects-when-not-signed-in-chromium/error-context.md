...
- Name: access-gates.spec.ts >> Unauthenticated access gates >> team page redirects when not signed in
- Location: tests\e2e\access-gates.spec.ts:19:7
...
Received string:  "http://localhost:3000/team"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    9 × unexpected value "http://localhost:3000/team"
