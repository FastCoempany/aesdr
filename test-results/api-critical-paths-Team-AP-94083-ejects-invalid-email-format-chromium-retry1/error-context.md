...
- Name: api-critical-paths.spec.ts >> Team API security >> POST /api/team/invite rejects invalid email format
- Location: tests\e2e\api-critical-paths.spec.ts:106:7
