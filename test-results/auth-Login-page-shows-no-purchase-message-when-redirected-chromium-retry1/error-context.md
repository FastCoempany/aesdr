...
- Name: auth.spec.ts >> Login page >> shows no-purchase message when redirected
...
Locator: locator('text=/purchase|access/i')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/purchase|access/i')
