# D28 — Pricing & Promo Sheet (for Partners)

**Deliverable:** One-page reference document the partner uses to know exactly what they can say about AESDR's pricing, what they can offer their audience, and what they cannot. The document the partner consults *before* writing any promotion copy. Pinned in the partner kit folder (D40) as the second-most-read document after the canon excerpt.
**Audience:** Partner principal + anyone on Partner's team writing copy that mentions AESDR pricing. Internal-only on the partner side; never republished as customer-facing collateral.
**Voice ratio:** 100 Rowan / 0 Michael per canon §3.3 (legal / partner agreement row — pricing is functionally legal-adjacent). Plain commercial register. No marketing voice.
...
## 3. What Partner can say about pricing
...
## 4. What Partner cannot say about pricing

Forbidden phrasings — using these requires AESDR to ask Partner to edit per canon §16; refusal triggers D22 §11.1 termination:

| Forbidden | Why |
|---|---|
| *"Limited time only — going up forever after this!"* | Untrue. List price is stable; pilot code is partner-specific and time-boxed. Per canon §9.2 anti-fake-urgency. |
...
A canonical, copy-pastable inclusion list. Use this exactly when a Partner needs to describe what the buyer gets:
...
## 9. Approval workflow for any pricing language Partner writes

Per canon §16 + D22 §8.2:

1. Partner drafts copy that mentions pricing.
2. Partner submits to AESDR for pre-approval at minimum 48 hours before publish.
3. AESDR responds within 24 business hours: APPROVED / APPROVED WITH EDITS / DECLINED.
4. Partner publishes only the APPROVED or APPROVED-WITH-EDITS version.

Approved phrasings in §3 above are pre-cleared — Partner may use them without resubmitting. Any deviation, however minor, is treated as new copy and goes through approval.
...
**Iris usage:** None. Internal/partner-side reference docs do not get iris fingerprint per canon §6.4.
...
- **D22 partner pilot agreement** — §8 above references D22 §5.1 commission. **In this batch.**
- **D19 disclosure-language pack** — partners using approved phrasings still must carry FTC disclosure. **Met.**
- **D40 master partner-kit folder README** — pinned reference doc in the kit. **In this batch.**

This sheet is a forward dependency for:
- **D26 partner-promo landing page** — co-branded page lifts approved phrasings.
- **D28 itself is referenced by:** every Partner-published surface that mentions pricing.
