...
affiliates don't need them and we'd rather not flood your inbox.
...
| `attribution_source` | `first_touch` (default) or `last_touch` if a multi-affiliate case |
| `refunded` | `true` / `false` |
...
your affiliate-attributed traffic.
