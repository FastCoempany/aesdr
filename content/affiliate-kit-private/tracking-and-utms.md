...
Your affiliate-attributed registration URL and the UTM scheme. Lift the
...
`[YOUR_SLUG]` is a short affiliate-specific identifier — usually your
...
affiliate code for 30 days. First-touch wins within the window — if they
later arrive via Google or direct, you're still the attributed affiliate.
...
|---|---|---|
| `utm_source` | Your affiliate slug (always) | `bdr-club` |
...
2. Verify the registration page loads with your affiliate slug visible
   somewhere on it.
3. Register with a test email (`[YOUR_NAME]+test@yourdomain.com`).
4. Within 5 minutes, log into your affiliate dashboard and verify the
