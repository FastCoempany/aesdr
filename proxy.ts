...
export async function proxy(request: NextRequest) {
  ...
  if (pathname.startsWith("/api/") || pathname.startsWith("/dashboard") || pathname.startsWith("/course") || pathname.startsWith("/tools/") || pathname.startsWith("/account") || pathname.startsWith("/auth/") || pathname.startsWith("/partners") || pathname.startsWith("/admin") || pathname.startsWith("/artifacts/") || pathname.startsWith("/preview/") || pathname === "/welcome" || pathname === "/reveal") {
    return supabaseResponse;
  }
